                ...
                <?php endif ?>
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Configure Tasks for Deployment
                        </div>
                        <div class="panel-body">
                        <form role="form" action="jobrun.php" method="post">
                            <div class="row">
                                <div class="col-lg-6">
                                     ...
                                     <div class="form-group">
                                            <label>Select Group of Server</label>
                                            <select class="form-control" name="servergroup">
                                                <option>-</option>
                                                <option>1</option>
                                                <option>2</option>
                                                <option>3</option>
